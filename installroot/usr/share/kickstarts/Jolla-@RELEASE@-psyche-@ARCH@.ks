# DisplayName: Jolla psyche/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: psyche
# DeviceVariant: psyche
# Brand: Jolla
...
repo --name=adaptation-common-psyche-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation0-psyche-@RELEASE@ --baseurl=https://sailfishos-psyche.github.io/repo/@RELEASE@/psyche/repo/
...
%packages
patterns-sailfish-device-configuration-psyche
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/psyche
